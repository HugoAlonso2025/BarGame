...
namespace BNG {
    ...
    public class Grabbable : MonoBehaviour {
        ...
        //Callbacks
        public System.Action OnGrabItem;
        public System.Action OnRelease;

        #region Modificacion de IO
        protected virtual void SetLastDropTime(float time)
        {
            LastDropTime = time;
        }

        protected virtual void GrabbCompleted()
        {
            OnGrabItem?.Invoke();
        }
        #endregion
